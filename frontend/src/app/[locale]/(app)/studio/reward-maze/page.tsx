...
const RewardMaze = dynamic(() => import('@/components/ai/RewardMaze'), {
  ssr: false,
  loading: () => <div className="h-48 animate-pulse rounded-card bg-white/60" aria-hidden="true" />,
});

export default function RewardMazePage() {
  const t = useTranslations('maze');

  return (
    <div data-testid="studio-maze-page" className="mx-auto flex max-w-3xl flex-col gap-5 px-4 py-6 md:px-8">
