...
// Client-only + code-split: the studio (and its lazy GIF encoder) never
// touches the SSR/main bundle.
const AnimationStudio = dynamic(() => import('@/components/ai/AnimationStudio'), {
  ssr: false,
...
export default function AnimatePage() {
  ...
  return (
    <div data-testid="studio-animate-page" className="mx-auto flex max-w-3xl flex-col gap-5 px-4 py-6 md:px-8">
      ...
      <AnimationStudio hideIntro={false} />
    </div>
  );
}
