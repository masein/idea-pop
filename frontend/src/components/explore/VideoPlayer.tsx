  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3 flex-shrink-0">
        ...
        {video.ai_generated && (
          <span className="bg-pricing/80 text-white text-xs px-2 py-0.5 rounded-pill font-body flex-shrink-0">
            AI
          </span>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4 flex flex-col gap-4">
        ...
        {ageMode === 'older' && video.design_secret && (
          <div className="bg-tint-lime rounded-card p-4">
            <p className="font-display text-sm text-ink mb-1">Design secret 🔬</p>
